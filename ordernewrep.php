...
<head>
	...
	<style>
		...
		#page-wrap { position: relative; width: 500px; margin: 50px auto; padding: 20px; background: white; -moz-box-shadow: 0 0 20px black; -webkit-box-shadow: 0 0 20px black; box-shadow: 0 0 20px black; }
...
<img src="img/20149_h_64863.png" width="450" height="205" />
...
<form method="post" action="ordernewrep.php" onsubmit='return formValidator()'>

<table class="table table-condensed" border="0" width="100"  height="80">
...
?>
      ...
      <td width="120"><input name="qt"  class="form-control" type="text" id="qt" /></td>

      <td>

      <input type="submit" class="btn btn-primary btn-lg btn-block active" id="addPro" value="Add" onclick=
