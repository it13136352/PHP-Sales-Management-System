    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="dash.html">Head Office</a>
            </div>
            <!-- Top Menu Items -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           <marquee direction="left" scrollamount="10" ><font style="text-transform:inherit" color="#0033FF"> Welcome To Link Five Food Company</font> </marquee>
                        </h1>
                        <!--<ol class="breadcrumb">
                            <li class="active">
                    ...
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                           <!-- <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                            <i class="fa fa-info-circle"></i>  <strong>Allert</strong>  -->
                           <img src="img/19289546-Tomato-sauce-in-a-bowl-and-spices-on-a-white-background-Stock-Photo copy.jpg" width="1000" height="500"> </div>
                  </div>
                </div>
                <!-- /.row -->
