...
mysql_select_db($database_link, $link);
$query_itemedit = "SELECT * FROM item WHERE item_id=%s";
$itemedit = mysql_query($query_itemedit, $link) or die(mysql_error());
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><?php echo $row_itemedit['item_id']; ?></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Item_name:</td>
      <td><input type="text" name="item_name" value="<?php echo htmlentities($row_itemedit['item_name'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Unite_price:</td>
      <td><input type="text" name="unite_price" value="<?php echo htmlentities($row_itemedit['unite_price'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
  ...
  <input type="hidden" name="item_id" value="<?php echo $row_itemedit['item_id']; ?>" />
</form>
<p>&nbsp;</p>
</body>
</html>
