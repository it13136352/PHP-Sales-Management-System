...
$stock = mysql_query($query_stock, $link) or die(mysql_error());
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="item_name" value="<?php echo htmlentities($row_stock['item_name'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Item_size:</td>
      <td><input type="text" name="item_size" value="<?php echo htmlentities($row_stock['item_size'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Unit_price:</td>
      <td><input type="text" name="unit_price" value="<?php echo htmlentities($row_stock['unit_price'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Quantity:</td>
      <td><input type="text" name="quantity" value="<?php echo htmlentities($row_stock['quantity'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
