...
function isAlphabet(elem, helperMsg){
  ...
  <table align="center">
    ...
    <tr valign="centerline">
      ...
      <td><input type="text" class="form-control" name="phoneNo" value="" size="32" id='letters'></td>
    </tr>
    <tr valign="centerline">
    ...
    <tr valign="centerline">
      ...
      <td><input type="submit" class="btn btn-primary btn-lg btn-block active" value="Insert record" onclick="isAlphabet(document.getElementById('letters'), 'Letters Only Please')" ></td>
    </tr>
  </table>
...
<div class="col-lg-6">
                    <table class="table table-condensed" border="1">
                      ...
                      <?php do { ?>
                        <tr>
                     <td><a href="updateuser.php?id=<?php echo $row_user['id']; ?>"><?php echo $row_user['id']; ?></a></td>
                          ...
                          <td><a href="delete.php?id=<?php echo $row_user['id']; ?>"><img src="img/delete.png" width="153" height="36"></a></td>
